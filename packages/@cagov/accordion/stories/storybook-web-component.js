      ...
      <div class="card">
        ...
        >
          <div class="accordion-title">
            <h4>
              What are the similarities and differences between Influenza (flu)
              and COVID-19?
            </h4>
          </div>
          <div class="plus-munus"></div>
        </button>
        <div class="card-container" aria-hidden="true" style="height: 0px;">
          <div class="card-body">
            <p>
              Influenza (flu) and COVID-19 are both contagious respiratory
              illnesses, but they’re caused by different viruses. COVID-19 is
              caused by a
              <a
                href="https://www.cdc.gov/coronavirus/2019-ncov/faq.html#Basics"
            ...
            <p>
              The symptoms of flu and COVID-19 are similar. It is hard to tell
              the difference between them without testing.
            </p>
            <p>
              Cases of COVID-19 and flu can have anything from no symptoms
              (asymptomatic) to severe symptoms. Common symptoms that COVID-19
              and flu share include:
            </p>
            <ul>
            ...
            <p>
              The major difference between them is COVID-19 may include change
              in or loss of taste or smell.
            </p>
            <p>
