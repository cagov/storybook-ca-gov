...
class CAGovReopening extends window.HTMLElement {
  ...
  connectedCallback () {
    ...
    this.state = {};
    this.innerHTML = templatize(this.json.pubData);
  ...
  //       <p>${this.json.countyRestrictionsAdvice} <a href="../get-local-information">${this.json.countyRestrictionsCountyWebsiteLabel}</a>.</p>
  //     </div>`
