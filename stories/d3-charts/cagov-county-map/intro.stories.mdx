...
<Meta title="d3-charts/cagov-county-map/intro" />
...
Learn more about [this project](https://cagov.github.io/covid19.ca.gov-site-handbook/tech)
 ...
 <img class="medium-image" src={Diagram_Intro} title="Image of Safer Economy Tier Status map, taken January 12, 2020." alt="Diagram of the counties in the State of California with active counties highlighted in tier status colors." />
 Image of Safer Economy Tier Status map, taken January 12, 2020.
